<?php
// logout.php - Stylish Logout Page
...
try {
    ...
    // Get current user before logging out (for goodbye message)
    ...
    // Even if there's an error, continue to show logout page
}
...
<head>
    ...
    <title>Logged Out - Elm Finance</title>
...
<body>
    ...
    <div class="container glass-card animate-fadeInUp">
        <div class="logo">
            ...
            <p>Financial Management for Students</p>
        </div>
        
        <div class="logout-message">
            <div class="logout-icon success-check" style="font-size: 5rem;">✅</div>
            <h2 class="logout-title">Successfully Logged Out</h2>
            <?php if (!empty($username)): ?>
            <p class="logout-text">
                Goodbye, <span class="username"><?php echo htmlspecialchars($username); ?></span>!
            </p>
            <?php endif; ?>
            <p class="logout-text">
                You have been securely logged out of your account.
            </p>
            <p class="logout-text" style="font-size: 1rem; opacity: 0.8;">
        ...
        <div class="security-notice" style="margin-top: 2rem; font-size: 1rem; color: var(--text-secondary); opacity: 0.7;">
            🔒 Session terminated • Secure logout complete
        </div>
    </div>
